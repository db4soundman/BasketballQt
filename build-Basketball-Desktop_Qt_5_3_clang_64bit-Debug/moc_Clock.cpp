...
QT_MOC_LITERAL(6, 49, 2)
    },
    "Clock\0clockExpired\0\0clockUpdated\0tick\0"
    "resetClock\0ot"
};
...
void Clock::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->clockExpired(); break;
        case 1: _t->clockUpdated(); break;
        case 2: _t->tick(); break;
        case 3: _t->resetClock((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 4: _t->resetClock(); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Clock::clockExpired)) {
                *result = 0;
            }
        }
        {
            typedef void (Clock::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Clock::clockUpdated)) {
                *result = 1;
            }
        }
    }
...
// SIGNAL 0
void Clock::clockExpired()
{
    QMetaObject::activate(this, &staticMetaObject, 0, 0);
}

// SIGNAL 1
void Clock::clockUpdated()
{
