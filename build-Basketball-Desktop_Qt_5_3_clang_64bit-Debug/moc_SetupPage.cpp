...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_SetupPage_t, stringdata) + ofs \
...
QT_MOC_LITERAL(7, 76, 6)
    ...
    "SetupPage\0homeBrowse\0\0awayBrowse\0"
    "statCrewBrowse\0awayColorDiag\0homeColorDiag\0"
    "bgDiag"
};
...
void SetupPage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->homeBrowse(); break;
        case 1: _t->awayBrowse(); break;
        case 2: _t->statCrewBrowse(); break;
        case 3: _t->awayColorDiag(); break;
        case 4: _t->homeColorDiag(); break;
        case 5: _t->bgDiag(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObject SetupPage::staticMetaObject = {
    { &QWizardPage::staticMetaObject, qt_meta_stringdata_SetupPage.data,
      qt_meta_data_SetupPage,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_SetupPage.stringdata))
